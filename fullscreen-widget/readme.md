...
6. The `Switch monitor` and `Browse` layout switch buttons will not work by default until you edit the script with your personal layout names and un-comment those lines. 
