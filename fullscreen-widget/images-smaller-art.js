	...
	this.paint = function (gr) {
		if (this.is_bio_panel) {
			...
			if (this.properties.aspect.value == image.full) {
				this.draw_blurred_image(gr);
				_drawImage(gr, this.bitmap.normal, this.x + 20 + 0.14*panel.w, this.y + 20 + 0.04*panel.h, this.w - 40, this.h - 40, this.properties.aspect.value, 1.0, RGB(150, 150, 150));
			} else {
				_drawImage(gr, this.bitmap.normal, this.x + 0.14*panel.w, this.y + 0.04*panel.h, this.w, this.h, this.properties.aspect.value);
			}
		}
	}
