...
2. Download the icons I've provided in the root directory/foobar2000_icons.
   The images you need for these widgets are in playback_widget and layout_buttons.
   Alternatively, you can make your own icons. Put these icons in a place
   you can remember*.
3. Download playback-widget.js from this folder, and place it in this
   folder:
...
4. Copy the code from any of the 1080p or 1440p playback widget scripts
   into a JScript Panel in your instance foobar2000.
