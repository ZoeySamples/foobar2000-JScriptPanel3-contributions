...
6. For lyrics to show up, you must have the lyrics saved in the %UnsyncedLyrics% or %Unsynced Lyrics% metadata field. I use the [OpenLyrics](https://www.foobar2000.org/components/view/foo_openlyrics) component to search and save lyrics automatically. If you do this, it should automatically populate in this widget.
